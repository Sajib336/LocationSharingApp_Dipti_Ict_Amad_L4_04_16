...
import com.example.locationsharingapp_dipti_ict_amad_l4_04_16.databinding.ActivityMapsDiptiIctAmadL40416Binding
...
class MapsActivity_Dipti_Ict_Amad_L4_04_16 : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityMapsDiptiIctAmadL40416Binding
    private lateinit var FirestoreViewModel: FirestoreViewModel_Dipti_Ict_Amad_L4_04_16

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityMapsDiptiIctAmadL40416Binding.inflate(layoutInflater)
