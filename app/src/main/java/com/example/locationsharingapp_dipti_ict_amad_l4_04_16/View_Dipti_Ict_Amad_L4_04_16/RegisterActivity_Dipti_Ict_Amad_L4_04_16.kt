...
import com.example.locationsharingapp_dipti_ict_amad_l4_04_16.databinding.ActivityRegisterDiptiIctAmadL40416Binding
import com.google.firebase.Firebase
import com.google.firebase.auth.auth

class RegisterActivity_Dipti_Ict_Amad_L4_04_16 : AppCompatActivity() {
    private lateinit var binding: ActivityRegisterDiptiIctAmadL40416Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityRegisterDiptiIctAmadL40416Binding.inflate(layoutInflater)
        ...
        binding.loginTxt.setOnClickListener {
            startActivity(Intent(this, LoginActivity_Dipti_Ict_Amad_L4_04_16::class.java))
        }
    ...
    override fun onStart() {
        ...
        if (Firebase.auth.currentUser != null) {
            startActivity(Intent(this@RegisterActivity_Dipti_Ict_Amad_L4_04_16, MainActivity_Dipti_Ict_Amad_L4_04_16::class.java))
            finish()
        }
    }
}